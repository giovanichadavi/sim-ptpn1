...
@section('content')
    <!-- Hero Section -->
    <section class="hero-section py-32 text-white bg-cover bg-center" id="home"
        ...
        <div class="container mx-auto px-4 text-center">
            <div class="text-shadow-md mb-8 space-y-4">
                ...
                <p class="shadow-md text-xl md:text-2xl">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
                ...
                <div class="overflow-hidden rounded-lg shadow-lg">
                    <img class="h-64 w-full object-cover transition duration-500 hover:scale-110"
                        src="/images/gallery/image-1.jpeg" alt="Palm Plantation">
                </div>

                <div class="overflow-hidden rounded-lg shadow-lg">
                    <img class="h-64 w-full object-cover transition duration-500 hover:scale-110"
                        src="/images/gallery/image-2.jpg" alt="Palm Trees">
                </div>

                <div class="overflow-hidden rounded-lg shadow-lg">
                    <img class="h-64 w-full object-cover transition duration-500 hover:scale-110"
                        src="/images/gallery/image-3.jpg" alt="Palm Oil Processing">
                </div>

                <div class="overflow-hidden rounded-lg shadow-lg">
                    <img class="h-64 w-full object-cover transition duration-500 hover:scale-110"
                        src="/images/gallery/image-4.jpg" alt="Sustainable Farming">
                </div>

                <div class="overflow-hidden rounded-lg shadow-lg">
                    <img class="h-64 w-full object-cover transition duration-500 hover:scale-110"
                        src="/images/gallery/image-5.jpg" alt="Palm Oil Products">
                </div>

                <div class="overflow-hidden rounded-lg shadow-lg">
                    <img class="h-64 w-full object-cover transition duration-500 hover:scale-110"
                        src="/images/gallery/image-6.jpeg" alt="Quality Control">
                </div>
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow-lg">
                    <img class="h-56 w-full object-cover"
                        src="/images/products/produk-1.jpg"
                        alt="Kelapa Sawit">
                    ...
                    <div class="p-6">
                        ...
                        <p class="mb-4 text-gray-600">
                            Kelapa Sawit merupakan komoditas utama dari PT Perkebunan Nusantara III (Persero).
                        </p>
                    </div>
                </div>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow-lg">
                    <img class="h-56 w-full object-cover"
                        src="/images/products/produk-2.jpeg"
                        alt="Karet">
                    ...
                    <div class="p-6">
                        ...
                        <p class="mb-4 text-gray-600">
                            Karet merupakan salah satu komoditas yang dikelola oleh PT Perkebunan Nusantara III.
                        </p>
                    </div>
                </div>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow-lg">
                    <img class="h-56 w-full object-cover"
                        src="/images/products/produk-3.jpg"
                        alt="Teh">
                    ...
                    <div class="p-6">
                        ...
                        <p class="mb-4 text-gray-600">
                            Teh merupakan salah satu komoditas perkebunan yang dikelola oleh PTPN III.
                        </p>
                    </div>
                </div>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow-lg">
                    <img class="h-56 w-full object-cover"
                        src="/images/products/produk-4.jpg"
                        alt="Kopi">
                    ...
                    <div class="p-6">
                        ...
                        <p class="mb-4 text-gray-600">
                            Kopi merupakan salah satu komoditas yang dibudidaya oleh PTPN III.
                        </p>
                    </div>
                </div>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <p class="mb-4 text-gray-600">
                            Tebu merupakan salah satu komoditas utama dari PT Perkebunan Nusantara III.
                        </p>
                    </div>
                </div>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow-lg">
                    <img class="h-56 w-full object-cover"
                        src="/images/products/produk-6.jpg"
                        alt="Kakao">
                    ...
                    <div class="p-6">
                        ...
                        <p class="mb-4 text-gray-600">
                            Kakao merupakan salah satu komoditas perkebunan dari PTPN III.
                        </p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div>
                    <form class="rounded-lg bg-white p-6 shadow-lg">
                        ...
                        <div class="mb-4">
                            <label class="mb-2 block font-bold text-gray-700">Nama</label>
                        ...
                        <div class="mb-4">
                            <label class="mb-2 block font-bold text-gray-700">Subjek</label>
                        ...
                        <div class="mb-4">
                            <label class="mb-2 block font-bold text-gray-700">Pesan</label>
                ...
                <div>
                    <div class="h-full rounded-lg bg-white p-6 shadow-lg">
                        ...
                        <h3 class="mb-4 text-xl font-bold text-green-700">
                            Informasi Kami
                        </h3>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="max-w-[460px] text-gray-600">
                                        Jl. Slt. Abdurrahman No.11, Pontianak, Kalimantan Barat
                                    </p>
                                </div>
                            </div>
